...
from userlist import capitalchristianUsers
...
class PowerSchool(object):
    ...
    def run(self, username, userpwd):
        ...
        url = "https://capitalchristian.powerschool.com/public"
        driver.get(url)
        ...
        print driver.save_screenshot("run1.png")
        ...
        time.sleep(10)
        self.prooCookies()
        print driver.save_screenshot("run2.png")
...
if __name__ == "__main__":
    app = PowerSchool()
    trymax = 2
    for user in capitalchristianUsers:
